(function () {
  ...
  window.CareApi = {
    ...
    listWaterIntake: function () { return request("/api/water-intake"); },
    createWaterIntake: function (data) { return request("/api/water-intake", { method: "POST", body: data }); },
    updateWaterIntake: function (id, data) { return request("/api/water-intake/" + encodeURIComponent(id), { method: "PUT", body: data }); },
    deleteWaterIntake: function (id) { return request("/api/water-intake/" + encodeURIComponent(id), { method: "DELETE" }); },
    listUrineOutput: function () { return request("/api/urine-output"); },
    createUrineOutput: function (data) { return request("/api/urine-output", { method: "POST", body: data }); },
    updateUrineOutput: function (id, data) { return request("/api/urine-output/" + encodeURIComponent(id), { method: "PUT", body: data }); },
    deleteUrineOutput: function (id) { return request("/api/urine-output/" + encodeURIComponent(id), { method: "DELETE" }); },
